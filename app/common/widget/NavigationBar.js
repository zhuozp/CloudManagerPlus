    ...
    leftView() {
        ...
        return (
            <TouchableOpacity
                ...
                <View style={{width: GlobalStyles.scaleSize(100), alignItems: 'center', flex: 1, justifyContent: 'center'}}>
    ...
    render() {
        ...
        let content = this.props.hide ? null :
            <View style={styles.navBar}>
                ...
                {/*{this.rightView()}*/}
                {this.getButtonElement(this.props.rightButton, {marginRight: GlobalStyles.scaleSize(16),})}
            </View>;
        return (
...
const styles = StyleSheet.create({
    ...
    navBarTitleContainer: {
        ...
        position: 'absolute',
        left: GlobalStyles.scaleSize(80),
        top: 0,
        right: GlobalStyles.scaleSize(80),
        bottom: 0,
    },
    title: {
        fontSize: GlobalStyles.setSpText(20),
        color: '#ffffff',
